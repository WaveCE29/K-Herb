...
class CategoryWidget extends StatefulWidget {
  ...
  })  : this.selectedCategory = selectedCategory ?? 'Leaves',
        super(key: key);
...
class _CategoryWidgetState extends State<CategoryWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    List serchObject(String c_name) {
      final res =
          objectTest.where((object) => object['category'] == c_name).toList();

      return res;
    }

    String serchUrlInObject(String name) {
      final res = objectTest.firstWhere((object) => object['name_th'] == name);
      if (res == -1) {
        return "not found";
      }
    ...
    var value_from_obj = serchObject(widget.selectedCategory);
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(16.0, 12.0, 0.0, 44.0),
                child: Wrap(
                  spacing: 8.0,
                  runSpacing: 8.0,
                  ...
                  children: List.generate(value_from_obj.length, (index) {
                    return InkWell(
                      onTap: () =>
                          {serchUrlInObject(value_from_obj[index]['name_th'])},
                      //     async {
                      //   context.pushNamed(
                      //     'DetailsEvent',
                      //     queryParams: {
