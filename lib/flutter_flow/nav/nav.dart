      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ...
              : HomepageWidget(
                  showCameraOption:
                      params.getParam('showCameraOption', ParamType.bool),
                ),
        ),
        FFRoute(
          name: 'Category',
          ...
          builder: (context, params) => CategoryWidget(
            selectedCategory:
                params.getParam('selectedCategory', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'History',
        ...
        FFRoute(
          ...
          path: '/predictpage',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Predictpage')
              : PredictpageWidget(
                  urlImages: params.getParam('urlImages', ParamType.String),
                ),
        ),
        FFRoute(
          name: 'DetailsEvent',
